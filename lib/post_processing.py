...
class WindTunnelOutput:
    ...
    def get_object_pressure_field(self, save_path: str = None):
...
class FlowSlice:
    ...
    def __init__(self, object_mesh, flow_slice, sim_output_path):
...
class Streamlines:
    ...
    def __init__(self, object_mesh, streamlines, sim_output_path):
        self.object_mesh = object_mesh
...
class MeshData:
    ...
    def render(self,
               ...
               virtual_display: bool = False,
               save_path: str = "pressure_field.png"):
